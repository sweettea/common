...
* Mon Nov 04 2024 Chung Chung <cchung@redhat.com> - 1.0-34
- Add support for Fedora 41

* Wed Oct 30 2024 Chung Chung <cchung@redhat.com> - 1.0-33
- Don't run dkms checks for dm_vdo kernel module
